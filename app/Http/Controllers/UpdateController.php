...
class UpdateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('index', compact('pacijent'));
    ...
    public function store(Request $request)
    {
       ...
       public function edit($ID_pacijenta)
    {
    ...
    public function update(Request $request, $ID_pacijenta)
    {
        ...
        $pacijent->save();
        return redirect()->route('update.index')->with('success', 'Podaci o pacijentu su ažurirani');
    }
    public function destroy($ID_pacijenta)
    {
        $pacijent = Pacijent::find($ID_pacijenta);
        $pacijent->delete();
        return redirect()->route('update.index')->with('success', 'Pacijent uklonjen!');
}
}